...
def simuler_optimisation_logistique_v2():
    ...
    st.info("""1.  **Production :** Augmenter la cadence de production de bio-huile de 15% pour les 7 prochains jours.
...
def simuler_rapport_fmi():
    ...
    with st.expander(" 🌱 Secteur Agricole & Énergie"):
        ...
        st.markdown("- Vente de biochar à prix subventionné aux exploitants locaux pour améliorer les sols.")
    with st.expander("💻 Secteur Numérique & Emploi"):
        st.markdown("- Création d’un réseau autonome IA-native sur panneaux solaires pour les zones rurales.")
        st.markdown("- Objectif : +1000 emplois verts et formation aux nouvelles technologies.")
...
def simuler_rapport_commune():
    ...
    st.markdown("- ✅ Étude des gisements de déchets bois flottés post-cycloniques.")
    st.markdown("- ✅ Mise en place d’un comité local Rekarbon avec élus et agriculteurs.")
    st.markdown("- ✅ Implantation d'un site test dans la zone agricole de Savannah.")
